(function () {
  ...
  JSLITE.ready(function () {
    ...
    JSLITE.dom.fly("keySignatures").on("click", function (e) { //note we're only binding one event listener for the entire page (because of this make sure each <span> entirely covers each <a>);
