...
var gcCalFrame="#33587D";	// the background color of the inner table, showing as a frame.
...
var gcCellBG="#DFECF9";	// default background color of the cells. Use "" for transparent!!!
...
var gcSatBG="#DFECF9";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#DFECF9";	// Sunday background color

var gcOtherDay="#DFECF9";	// the font color of days in other months; It's of no use when giShowOther is set to hide.
...
var gcToggle="#FFECAB";	// the highlight color for the focused cell
